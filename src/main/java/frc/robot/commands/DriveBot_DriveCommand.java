...
public class DriveBot_DriveCommand extends CommandBase {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final DriveBot_DrivetrainSubsystem m_drivesubsystem;
   ...
   */
  public DriveBot_DriveCommand(DriveBot_DrivetrainSubsystem subsystem, DoubleSupplier _leftDrive, DoubleSupplier _rightDrive) {
