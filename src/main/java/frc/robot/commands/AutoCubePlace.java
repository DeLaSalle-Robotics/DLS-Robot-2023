...
public class AutoCubePlace extends SequentialCommandGroup{
    double armAngle;
    double armLength;

    public AutoCubePlace(Arm _arm, ArmExtend _armExtend, Intake m_grasper, DrivetrainSubsystem m_drive) {
        armAngle = 33.6;
        armLength = 140000;
        ...
        addCommands(
            ...
            new ParallelRaceGroup(
                ...
                new WaitCommand(2.5)),
            new ParallelCommandGroup(
                new SpinIntake(m_grasper, () -> 1, () -> 0),
                new WaitCommand(0.2)
            ),
            new ToggleClaw(m_grasper),
            new SpinIntake(m_grasper ,() -> 0, () ->0),
            new ParallelRaceGroup (
                new WaitCommand(0.5),
                new KeepArmPosition(armAngle, _arm)),
            new ParallelRaceGroup(
